...
pub type FIFOE_W<'a, const O: u8> = crate::BitWriter<'a, FCR_SPEC, O>;
#[doc = "Field `rfifor` writer - "]
pub type RFIFOR_W<'a, const O: u8> = crate::BitWriter<'a, FCR_SPEC, O>;
#[doc = "Field `xfifor` writer - "]
pub type XFIFOR_W<'a, const O: u8> = crate::BitWriter<'a, FCR_SPEC, O>;
#[doc = "\n\nValue on reset: 0"]
...
pub type DMAM_W<'a, const O: u8> = crate::BitWriter<'a, FCR_SPEC, O, DMAM_AW>;
...
#[doc = "Field `rt` writer - "]
pub type RT_W<'a, const O: u8> = crate::FieldWriterSafe<'a, FCR_SPEC, 2, O, RT_AW>;
