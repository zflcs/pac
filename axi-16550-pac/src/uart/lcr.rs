...
pub type DLS_W<'a, const O: u8> = crate::FieldWriterSafe<'a, LCR_SPEC, 2, O, DLS_A>;
...
pub type STOP_W<'a, const O: u8> = crate::BitWriter<'a, LCR_SPEC, O, STOP_A>;
...
pub type PEN_W<'a, const O: u8> = crate::BitWriter<'a, LCR_SPEC, O, PEN_A>;
...
pub type EPS_W<'a, const O: u8> = crate::FieldWriterSafe<'a, LCR_SPEC, 2, O, EPS_A>;
...
pub type BC_W<'a, const O: u8> = crate::BitWriter<'a, LCR_SPEC, O>;
...
pub type DLAB_W<'a, const O: u8> = crate::BitWriter<'a, LCR_SPEC, O, DLAB_A>;
