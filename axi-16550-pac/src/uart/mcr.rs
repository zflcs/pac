...
pub type DTR_W<'a, const O: u8> = crate::BitWriter<'a, MCR_SPEC, O, DTR_A>;
...
pub type RTS_W<'a, const O: u8> = crate::BitWriter<'a, MCR_SPEC, O, RTS_A>;
...
pub type LOOP_W<'a, const O: u8> = crate::BitWriter<'a, MCR_SPEC, O, LOOP_A>;
