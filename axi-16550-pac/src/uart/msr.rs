...
pub type DCTS_W<'a, const O: u8> = crate::BitWriter<'a, MSR_SPEC, O, DCTS_A>;
...
pub type DDSR_W<'a, const O: u8> = crate::BitWriter<'a, MSR_SPEC, O, DDSR_A>;
...
pub type TERI_W<'a, const O: u8> = crate::BitWriter<'a, MSR_SPEC, O, TERI_A>;
...
pub type DDCD_W<'a, const O: u8> = crate::BitWriter<'a, MSR_SPEC, O, DDCD_A>;
...
pub type CTS_W<'a, const O: u8> = crate::BitWriter<'a, MSR_SPEC, O, CTS_A>;
...
pub type DSR_W<'a, const O: u8> = crate::BitWriter<'a, MSR_SPEC, O, DSR_A>;
...
pub type RI_W<'a, const O: u8> = crate::BitWriter<'a, MSR_SPEC, O, RI_A>;
...
pub type DCD_W<'a, const O: u8> = crate::BitWriter<'a, MSR_SPEC, O, DCD_A>;
