...
pub type ERBFI_W<'a, const O: u8> = crate::BitWriter<'a, IER_SPEC, O, ERBFI_A>;
...
pub type ETBEI_W<'a, const O: u8> = crate::BitWriter<'a, IER_SPEC, O, ETBEI_A>;
...
pub type ELSI_W<'a, const O: u8> = crate::BitWriter<'a, IER_SPEC, O, ELSI_A>;
...
pub type EDSSI_W<'a, const O: u8> = crate::BitWriter<'a, IER_SPEC, O, EDSSI_A>;
