...
pub type DR_W<'a, const O: u8> = crate::BitWriter<'a, LSR_SPEC, O, DR_A>;
...
pub type OE_W<'a, const O: u8> = crate::BitWriter<'a, LSR_SPEC, O, OE_A>;
...
pub type PE_W<'a, const O: u8> = crate::BitWriter<'a, LSR_SPEC, O, PE_A>;
...
pub type FE_W<'a, const O: u8> = crate::BitWriter<'a, LSR_SPEC, O, FE_A>;
...
pub type BI_W<'a, const O: u8> = crate::BitWriter<'a, LSR_SPEC, O>;
...
pub type THRE_W<'a, const O: u8> = crate::BitWriter<'a, LSR_SPEC, O, THRE_A>;
...
pub type TEMT_W<'a, const O: u8> = crate::BitWriter<'a, LSR_SPEC, O, TEMT_A>;
...
pub type FIFOERR_W<'a, const O: u8> = crate::BitWriter<'a, LSR_SPEC, O, FIFOERR_A>;
